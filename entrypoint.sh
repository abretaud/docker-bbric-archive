...
export ARCHIVE_CLIENT_MOUNTPOINT
echo -e "# Client\n
export ARCHIVE_CLIENT_MOUNTPOINT=${ARCHIVE_CLIENT_MOUNTPOINT}" >> /etc/profile
echo -e "# Client\n
export ARCHIVE_CLIENT_MOUNTPOINT=${ARCHIVE_CLIENT_MOUNTPOINT}" >> /etc/bash.bashrc
